...
library(dplyr)
	...
	# Create a list of the files you want to read in
		setwd("U:/UF/Data/NMFS/MRIP data/MRIP/CSVs/raw/2010_2014/trips") #for whatever reason, it seems that you must re-direct the WD...not sure why
		all.files <- list.files(path = "U:/UF/Data/NMFS/MRIP data/MRIP/CSVs/raw/2010_2014/trips", pattern = ".csv") #this is a test trips from 2018--watch for cap changes with other years
	...
	#Writing out data
		...
		save(dt, file = "All_2010_2014.RData")
		save(dt_fl, file = "FL_2010_2014.RData")
